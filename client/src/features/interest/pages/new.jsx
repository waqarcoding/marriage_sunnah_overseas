...
import { ChevronLeft, Star, Clock, MessageCircle, Heart, MapPin, X } from "lucide-react";
                                    ...
                                    >
                                        ...
                                        {item.status === "accepted" && (
                                            <motion.button
                                                ...
                                                className="mt-1 w-full flex items-center justify-center gap-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white py-2.5 rounded-xl text-sm font-medium shadow-md"
                                            >
