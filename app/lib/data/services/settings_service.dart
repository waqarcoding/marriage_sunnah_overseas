...
class SettingsService extends GetxService {
  ...
  bool get userVerificationRequired =>
      settings.value?.userVerificationRequired ?? false;
  bool get guardianVerificationRequired =>
  ...
  int get freeCreditsVerification =>
      settings.value?.freeCreditsVerification ?? 5;
  int get referralCreditsReferrer =>
      settings.value?.referralCreditsReferrer ?? 20;
  int get referralCreditsReferee =>
      settings.value?.referralCreditsReferee ?? 10;
  ...
  bool get guardianApprovalRequired =>
      settings.value?.guardianApprovalRequired ?? false;
  bool get guardianCanBrowse => settings.value?.guardianCanBrowse ?? true;
  bool get guardianCanSendInterests =>
      settings.value?.guardianCanSendInterests ?? true;
  int get maxGuardiansPerUser => settings.value?.maxGuardiansPerUser ?? 2;
  int get guardianAutoApproveHours =>
      settings.value?.guardianAutoApproveHours ?? 72;
  ...
  bool get successStoriesEnabled =>
      settings.value?.successStoriesEnabled ?? true;
  ...
  // Referral
  double get referralCommissionPercentage =>
      settings.value?.referralCommissionPercentage ?? 10.0;
